    ...
    <div className={styles.containers}>
      ...
      <div className={styles.flex} style={{ background: "#F9F9F9" }}>
        ...
        <label style={{ textAlign: "left" }}>
          <a href="">
            Davlat muassasalari va jamoat xizmati xodimlari kasaba uyushmasi
            Respublika kengashi
          </a>
        </label>
      </div>
      <div className={styles.flex}>
        ...
        <label style={{ textAlign: "left" }}>
          <a href="">Mirzo Ulug’bek tuman kengashi</a>
        </label>
      </div>
      <div className={styles.flex} style={{ background: "#F9F9F9" }}>
      ...
      <div className={styles.flex}>
        ...
        <label style={{ textAlign: "left" }}>
          1726269 - Toshkent shahar, Mirzo Ulug’bek tumani
        </label>
      </div>
      <div className={styles.flex} style={{ background: "#F9F9F9" }}>
        <label>{t("passort-primary-organization.firstOrganizationAdr")}</label>
        <label style={{ textAlign: "left" }}>
          Toshkent shahar Butuk Ipak Yo’li
        </label>
      </div>
      <div className={styles.flex}>
