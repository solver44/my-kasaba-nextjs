...
class HtmlRenderer {
    ...
    renderDefaultStyle() {
        ...
        var styleText = `
.${c}-wrapper { background: white; padding: 0px; padding-bottom: 0px; display: flex; flex-flow: column; align-items: center; } 
.${c}-wrapper>section.${c} { background: white; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2); margin-bottom: 30px; }
.${c} { color: black; }
